...
5. Disable affiliate redirects and public CMS writes, use local media storage, and keep Production S3, email, webhook, analytics and affiliate credentials absent. Add a sandbox credential only through separate approval.
