...
- **Planned:** any separately authorised quality evaluation for the other seven operational-agent specialists; any separately authorised Production Google or PROGRAM-AI provider activation; an approved email transport; COMMS-REMINDER-01; durable age evidence; distributed Programme rate limiting; automated anonymous-data purge; and approved legacy raw-data cleanup.
