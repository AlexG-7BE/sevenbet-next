...
function localeVariant(locale: keyof typeof compactTranslations): ProductPageMessages {
  ...
  return {
    ...
    casinos: {
      ...
      proofEvidence:n.source,proofLimit:n.records,proofPublished:n.published,directoryTitle:n.casinos,bestOverall,crypto,mobile,bestBonuses,newCasinos,noMatchesTitle:copy[3],noMatchesCopy:copy[1],noPublishedTitle:copy[3],reviewOnlyNotice:state,faqTitle:n.questions,
