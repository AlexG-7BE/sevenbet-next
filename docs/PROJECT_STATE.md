...
- **LAUNCH-POLISH-01:** **CURRENT MAIN INTEGRATED ON DRAFT REVIEW BRANCH; EXTERNAL MAIL ACTIVATION DEFERRED.** RFC-028 governs the resilient public 404/error hierarchy, `/contact`, `POST /api/contact`, isolated direct-HTTPS Resend adapter, privacy/retention delta, bounded link audit and WAF activation contract. PR #69 and PR #70 remain preserved. No mail DNS, provider account, Preview/Production secret, WAF, Production data or runtime flag has been changed; the 2026-08-14 09:00 Asia/Almaty mail-DNS boundary has not passed.
