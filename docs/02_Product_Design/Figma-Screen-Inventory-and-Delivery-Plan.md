...
|---|---:|---|
| `APPROVED` | 10 | Public Header, revised Public Footer, `/10-steps`, Casinos catalogue/empty state, Casino Profile available/unavailable, Bonuses catalogue/lifecycle and Best Offers shortlist families are visually approved across their completed responsive states. |
| `DESIGNED_NEEDS_QA` | 14 | Current Tilt-Locked design exists but user approval, responsive QA or wider journey handoff remains outstanding; this includes the new Comparison selection/result and no-comparable families. |
...
| `MISSING` | 25 | No adequate active Figma family was detected. |
...
| Desktop screens | Page `6:6`; Home, original Bonuses anchor `299:786`, approved Bonuses family `541:3002`, original Best Offers anchor `310:224`, approved Best Offers family `556:3336`, approved Casinos family `520:2496`, original Casino Profile anchor `343:601`, approved Casino Profile family `529:2850`, Comparison family `567:3592`, Protected article, Programme M01–M04 and `/10-steps` family `502:2238` | `/10-steps`, Casinos, Casino Profile, Bonuses and Best Offers are approved. Comparison is review ready across 1,440, 1,280 and ten explicit desktop states. |
| Mobile | Page `6:7`; Public Shell family `492:2268`, revised `/10-steps` family `502:2412`, Casinos family `521:312`, Casino Profile family `530:809`, Bonuses family `541:3950`, approved Best Offers family `557:1470` and Comparison family `569:1589` | Public Shell, `/10-steps`, Casinos, Casino Profile, Bonuses and Best Offers are approved. Comparison is review ready across full 390, 375 first fold and ten 390×844 states. |
...
| B10 | Commercial discovery | Comparison selection and result | Planned `/compare` | Compare selected eligible operators/offers | `DESIGNED_NEEDS_QA` | Desktop family `567:3592`; full 1440 `567:3594`; 1280 first fold `567:3868`; desktop contract `567:4091`; desktop states `568:106`; mobile family `569:1589`; full 390 `569:1591`; 375 first fold `569:1831`; mobile contract `569:2035`; mobile states `570:76` | Review ready: full 1440, 1280 first fold and ten-state contract | Review ready: full 390, 375 first fold and ten 390×844 states | **Not detected** | Comparable schema, selection state, trusted market context and published snapshots | Like-for-like terms, market eligibility, uncertainty, methodology and affiliate disclosure | P0 | Stop for visual approval. Production implementation remains blocked on a dedicated route/engine, comparable projection and trusted eligibility authority. |
| B11 | Commercial discovery | No comparable results | Planned `/compare` | Honest recovery when selections cannot be compared | `DESIGNED_NEEDS_QA` | Desktop `568:253`; mobile `570:168`; market restriction `568:282`, `570:186`; load recovery `568:311`, `570:204` | Review-ready no-comparable and fail-closed states | Review-ready no-comparable and fail-closed states | **Not detected** | Compatibility, eligibility and reason codes | No misleading fallback or referral action | P0 | Stop for visual approval; backend reason mapping remains required before implementation. |
...
| B13 | Commercial discovery | Affiliate disclosure and outbound action | Commercial cards/profiles | Make commercial relationship and destination explicit | `PARTIAL` | Disclosure fragments within `299:786`, `310:224`, `325:323`, `343:601`; Casino Profile desktop contract `529:3299`; profile confirmation `531:3983` / failure `531:3986`; Bonuses desktop contract `542:3328`; confirmation `544:4420`; failure `544:4421`; Best Offers desktop states `556:5324`; confirmation `560:5174`; failure `558:1723`; Comparison confirmation `568:340`, `570:222`; Comparison failure `568:369`, `570:242` | Casino Profile, Bonuses and Best Offers approved; Comparison review ready | Casino Profile, Bonuses and Best Offers confirmation/failure approved; Comparison review ready | **Detected — partial** | Approved internal redirect and eligible offer | Disclosure before leaving, no raw destination URL and safe recovery | P0 | Obtain visual approval for Comparison; production internal redirect and eligibility authority remain separate engineering dependencies. |
...
- The launch journey has an approved responsive Public Shell and approved revised `/10-steps`, Casinos, Casino Profile, Bonuses and Best Offers families, but no comparison family, dedicated Protected Help shell, or legal-system template set.
- Casino Profile, Bonuses and Best Offers establish approved fail-closed outbound treatments. Comparison remains outstanding.
...
- Figma page `06 — Screens / Mobile` contains approved Public Shell family `492:2268`, approved revised `/10-steps` family `502:2412`, approved Casinos family `521:312`, approved Casino Profile family `530:809`, approved Bonuses family `541:3950` and approved Best Offers family `557:1470`; the remaining launch families still lack active mobile frames.
...
- Full 390×844 mobile frames are still required for Home, Comparison, Dashboard, Protected Help and registration/sign-in. Casinos, Casino Profile, Bonuses and Best Offers have approved full 390 families plus representative 390×844 states.
...
- Casinos empty, generic restricted/unknown, unavailable and error states are approved; Casino Profile fail-closed states are approved; Bonuses expired/unavailable, safe-degradation and error states are approved; Best Offers equivalent states are approved. Comparison states, claim/session recovery and protected exits remain absent or fragmentary.
- Casino Profile, Bonuses and Best Offers have approved outbound confirmation/failure representatives; Comparison has not yet adopted the pattern.
...
7. **Comparison family — REVIEW READY** — selection, results, no comparable results, outbound recovery and mobile are complete in Figma and awaiting visual approval.
...
## Seventh design action — COMPARISON FAMILY REVIEW READY

The planned **`/compare` Comparison family** is designed in Figma as desktop family `567:3592` and mobile family `569:1589`. It uses the approved Public Shell without altering its source components and translates the Product Master Plan's “comparable means comparable” rule into a two-to-three-operator decision surface. The family is `DESIGNED_NEEDS_QA` pending user visual approval; operator names, values, market context and commercial availability are illustrative design content only.
...
- Approval: `DESIGNED_NEEDS_QA`. Stop for user visual review before changing the family label or moving to the next P0 family.

## Next screen family

After visual approval of Comparison, the next P0 candidate is **Programme QA through Mission 04**: mobile representatives and missing recovery/control states without redesigning sound desktop work.
