...
const en: ProductPageMessages = {
  ...
  profile: {
    ...
    marketUnavailable: "Review only for {market}", marketUnavailableCopy: "This profile does not publish offer availability for the current region. No eligibility is inferred and no partner link is available.",
...
const languageQualityOverrides = {
  "en-GB": {
    ...
    profile: {
      ...
      marketUnavailableCopy: "This profile does not show offer availability for the current region. The review remains available, but there is no partner link.",
  ...
  "es-ES": {
    ...
    profile: {
      ...
      marketUnavailableCopy: "Este perfil no muestra ofertas disponibles para la región actual. La reseña sigue disponible, pero no hay enlace de socio.",
  ...
  "sv-SE": {
    ...
    profile: {
      ...
      marketUnavailableCopy: "Profilen visar inga tillgängliga erbjudanden för den aktuella regionen. Recensionen finns kvar, men det finns ingen partnerlänk.",
  ...
  "da-DK": {
    ...
    profile: {
      ...
      marketUnavailableCopy: "Profilen viser ingen tilgængelige tilbud for den aktuelle region. Anmeldelsen er stadig tilgængelig, men der er intet partnerlink.",
  ...
  "el-GR": {
    ...
    profile: {
      ...
      marketUnavailableCopy: "Το προφίλ δεν εμφανίζει διαθέσιμες προσφορές για την τρέχουσα περιοχή. Η αξιολόγηση παραμένει διαθέσιμη, αλλά δεν υπάρχει σύνδεσμος συνεργάτη.",
