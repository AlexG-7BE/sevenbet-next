...
| `DESIGNED_NEEDS_QA` | 12 | Current Tilt-Locked design exists but user approval, responsive QA or wider journey handoff remains outstanding. |
...
- Full 390×844 mobile frames are still required for Home, Dashboard, Protected Help and registration/sign-in. Casinos, Casino Profile, Bonuses, Best Offers and Comparison have approved full 390 families plus representative 390×844 states.
...
The next P0 candidate is **Programme QA through Mission 04**: mobile representatives and missing recovery/control states without redesigning sound desktop work.
