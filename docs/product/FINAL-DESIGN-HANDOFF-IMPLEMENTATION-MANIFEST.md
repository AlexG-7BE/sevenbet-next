...
- **Detected:** Home runs the handoff reveal, floating-photo depth, sticky story stack, chameleon navigation and read progress. RFC-035 returns wheel/trackpad/keyboard/touch scroll to the browser, limits Home RAF work to pending scroll or spring settling and retains fail-visible no-JavaScript, missing-IntersectionObserver and reduced-motion paths.
