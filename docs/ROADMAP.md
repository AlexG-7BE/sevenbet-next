...
| 17 | GOOGLE-OAUTH-ACTIVATE-01 | **v2.1 correction candidate — Preview E2E pending** | RFC-021; one consolidated access screen, current purpose-separated server HMAC authority bound to an exact journey/original 60-minute lifetime, session-owned Programme home/header state and truthful zero-progress Dashboard. Static legal headers alone cannot authorize account creation. No schema, dependency, credential, commercial or Production mutation. |
