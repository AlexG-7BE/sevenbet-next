...
const sections = [
  ...
  },
  {
    ...
    content: <><p>This service uses only cookies or browser storage needed for a service you request, authentication, security, access confirmation, language preference, same-tab comparison selection and temporary Programme continuity. The presentation cookie stores language only; it does not store your country, raw IP address or commercial eligibility. We do not run non-essential product analytics or session replay.</p><p>Casino and offer pages do not load partner-hosted promotional creative frames, media pixels or impression requests. Language preference remains separate from trusted country detection and commercial eligibility.</p><p>Necessary B4GAMBLE storage is not reused for advertising, affiliate measurement or commercial personalisation. Browser controls can remove stored data, but disabling necessary storage may prevent requested language, account or Programme features from working.</p></>,
  },
  {
    id: "affiliate",
