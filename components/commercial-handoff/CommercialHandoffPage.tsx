  ...
  return (
    <section className={styles.page} data-commercial-handoff="confirmation" data-figma-desktop="679:5319" data-figma-mobile="679:8489">
      <div className={styles.confirmationCard}>
        ...
        <h1>You are leaving SevenBet.</h1>
        <p className={styles.copy}>SevenBet may receive a commission. Eligibility and destination are checked again before the internal redirect continues.</p>
        ...
        <div className={styles.actions}>
          ...
          <Link href="/">Cancel and stay on SevenBet</Link>
        </div>
      </div>
  ...
  return (
    <section className={styles.page} data-commercial-handoff="unavailable" data-figma-desktop="930:3111" data-figma-mobile="930:3123">
      <div className={styles.unavailableCard}>
        ...
        <p className={styles.copy}>SevenBet could not confirm an eligible outbound destination for this action. No redirect was completed, and no alternative offer has been substituted.</p>
        <p className={styles.failureBoundary}>No destination · No redirect · No substitute offer</p>
        <div className={styles.recoveryAction}>
          <Link href="/">Return to SevenBet</Link>
          <span>Use your browser Back action to return to the page you came from.</span>
        </div>
      </div>
      <p className={styles.footnote}>Affiliate relationships never permit SevenBet to invent availability or expose an unverified destination.</p>
    </section>
  );
}
