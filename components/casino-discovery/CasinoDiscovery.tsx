...
function FilterFields({ result, messages }: { result: CasinoDiscoveryResult; messages: ProductPageMessages }) {
  ...
  return <div className={styles.filterGrid}>
    ...
    <BooleanSelect active={Boolean(query.hasAvailableVisitAction)} activeLabel={messages.common.visitAvailability} emptyLabel={messages.common.visitAvailability} label={messages.common.visitAvailability} name="hasAvailableVisitAction" />
...
function SecondaryFilterFields({ result, messages }: { result: CasinoDiscoveryResult; messages: ProductPageMessages }) {
  ...
  return <div className={filterStyles.drawerGrid}>
    ...
    <BooleanSelect active={Boolean(query.hasAvailableVisitAction)} activeLabel={messages.common.visitAvailability} className={filterStyles.drawerField} emptyLabel={messages.common.visitAvailability} label={messages.common.visitAvailability} name="hasAvailableVisitAction" />
