...
| 26 | PROGRAM-AI-IMPL-01A | **M1 FOUNDATION + PREVIEW VERTICAL SLICE IMPLEMENTED ON FEATURE BRANCH; PR/PREVIEW PENDING** | Founder Office authority and [RFC-022](06_RFC/RFC-022-PROGRAM-AI-M1-Foundation-and-Preview-Vertical-Slice.md) authorise the bounded, exact-flag/default-off slice: combined JIT authority/intake, typed path, recorder fallback states, `20 + 20`, confirmed Starting Point, exact claim, truthful Home and M3/M6/M10 Review entitlements. No provider/SDK, Production flag/configuration, Google Production activation, generated Review or Mission 05–10 implementation is included. Legacy M1 remains the default. |
