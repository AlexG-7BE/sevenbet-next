...
| Account and Programme email delivery | Founder-approved Resend processing for transactional/account, welcome, consented Programme reminder and consented marketing purposes; Production delivery remains disabled | Minimum recipient, approved rendered message, sender/reply-to and opaque correlation data only; no Programme answers, vulnerability data, analytics history, affiliate tokens, browsing history, raw IP or auth/password token | **Detected:** RFC-046 Production ledgers and adapter plus a protected-cron activation candidate; live domain/DKIM/SPF, sending-only credentials, exact five-event signed webhook and Production sender configuration; worker deployment and delivery still pending | Founder authority was granted 2026-09-12. Exact agreement acceptance/entity, location, retention, subprocessors, UK transfer mechanism and full activation evidence remain **open**. |
