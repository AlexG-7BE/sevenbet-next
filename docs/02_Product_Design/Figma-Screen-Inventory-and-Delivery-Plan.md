...
| Desktop screens | Page `6:6`; Home, original Bonuses anchor `299:786`, Bonuses family `541:3002`, Best Offers, approved Casinos family `520:2496`, original Casino Profile anchor `343:601`, approved Casino Profile family `529:2850`, Protected article, Programme M01–M04 and `/10-steps` family `502:2238` | `/10-steps`, Casinos and Casino Profile are approved. Bonuses is review ready with 1,440, 1,280 and explicit desktop state coverage while retaining its original anchor. |
| Mobile | Page `6:7`; Public Shell family `492:2268`, revised `/10-steps` family `502:2412`, Casinos family `521:312`, Casino Profile family `530:809` and Bonuses family `541:3950` | Public Shell, `/10-steps`, Casinos and Casino Profile are approved; Bonuses is review ready across its completed responsive/state representatives. |
...
| B06 | Commercial discovery | Bonuses catalogue | `/bonuses` | Compare bonus structures and material terms | `DESIGNED_NEEDS_QA` | Original anchor `299:786`; desktop family `541:3002`; canonical 1440 `541:3952`; 1280 first fold `541:4216`; desktop states `542:3328`; mobile family `541:3950`; full 390 `542:4329`; filters open `544:4415`; filters applied `544:4416`; loading `544:4417`; 375 first fold `544:4422` | Review ready: full 1440, 1280 first fold and desktop state contract | Review ready: full 390, filter open/applied, loading and 375 first fold | **Detected — legacy/partial** | Canonical offer projection, published material terms, expiry and eligibility | Affiliate disclosure, terms-before-action, uncertainty and update date | P0 | Await visual approval; preserve the original anchor and approved Public Shell. Frontend parity and production offer authority remain separate. |
...
| B08 | Commercial discovery | Bonus unavailable / expired | `/bonuses` or offer context | Prevent stale referral and explain recovery | `DESIGNED_NEEDS_QA` | Desktop state contract `542:3328`; mobile availability states `544:4418`; market/error states `544:4419` | Review-ready expired, no-match, no-eligible, unknown/restricted and load-error contract | Review-ready 390 expired/unavailable and safe-degradation states | **Not detected** | Offer lifecycle, expiry and eligibility reason codes | No expired CTA; material terms and neutral routes remain readable | P0 | Await visual approval; backend/compliance reason mapping remains required before implementation. |
...
| B13 | Commercial discovery | Affiliate disclosure and outbound action | Commercial cards/profiles | Make commercial relationship and destination explicit | `PARTIAL` | Disclosure fragments within `299:786`, `310:224`, `325:323`, `343:601`; Casino Profile desktop contract `529:3299`; profile confirmation `531:3983` / failure `531:3986`; Bonuses desktop contract `542:3328`; confirmation `544:4420`; failure `544:4421` | Casino Profile complete; Bonuses review ready; other families partial | Casino Profile complete; Bonuses confirmation/failure review ready; other families missing | **Detected — partial** | Approved internal redirect and eligible offer | Disclosure before leaving, no raw destination URL and safe recovery | P0 | Await Bonuses approval, then propagate the governed fail-closed pattern to Best Offers and Comparison without inventing operator facts. |
...
- Figma page `06 — Screens / Mobile` contains approved Public Shell family `492:2268`, approved revised `/10-steps` family `502:2412`, approved Casinos family `521:312`, approved Casino Profile family `530:809` and review-ready Bonuses family `541:3950`; the remaining launch families still lack active mobile frames.
...
- Casinos empty, generic restricted/unknown, unavailable and error states are approved; Casino Profile fail-closed states are approved; Bonuses expired/unavailable, safe-degradation and error states are review ready. Equivalent Best Offers/Comparison states, claim/session recovery and protected exits remain absent or fragmentary.
- Casino Profile has an approved outbound confirmation/failure representative and Bonuses now has a review-ready equivalent; Best Offers and Comparison have not yet adopted the pattern.
...
- Casinos and Casino Profile have approved responsive Figma contracts; Bonuses has a review-ready responsive contract. Their current frontend routes remain legacy/partial and do not implement those contracts. Best Offers, Learning, Help and legal routes also remain incomplete or visually stale.
...
5. **Bonuses family — REVIEW READY** — catalogue, material terms, filters, expired/unavailable, outbound recovery and mobile are complete in Figma and awaiting visual approval.
...
## Fifth completed design action — BONUSES FAMILY REVIEW READY

The **`/bonuses` discovery family** is complete in Figma and awaiting visual approval as desktop family `541:3002` and mobile family `541:3950`. The original 1,440 Tilt-Locked anchor `299:786` remains unchanged; canonical desktop `541:3952` retains its visual hierarchy while the responsive and state representatives reuse the approved Public Shell. Family labels `541:3951` and `542:4328` read `REVIEW READY`.
...
- Status: `DESIGNED_NEEDS_QA`. The family is complete and review ready, but is not approved until the user visually accepts it.
