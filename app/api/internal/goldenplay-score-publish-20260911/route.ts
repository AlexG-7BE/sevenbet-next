...
export async function GET() {
  ...
  const next = {
    ...
    casinoBonuses: current.casinoBonuses.map((bonus) => ({
      id: bonus.id,
      slug: bonus.slug,
      internalName: bonus.internalName,
      title: bonus.title,
      ...
      wageringBase: bonus.wageringBase,
      minimumOdds: bonus.minimumOdds,
      maximumBet: bonus.maximumBet,
      wageringText: bonus.wageringText,
      eligibility: bonus.eligibility,
      eligibleGames: bonus.eligibleGames,
      excludedGames: bonus.excludedGames,
      eligiblePaymentMethods: bonus.eligiblePaymentMethods,
      excludedPaymentMethods: bonus.excludedPaymentMethods,
      newPlayersOnly: bonus.newPlayersOnly,
      existingPlayersAllowed: bonus.existingPlayersAllowed,
      ...
      evergreen: bonus.evergreen,
      featured: bonus.featured,
      exclusive: bonus.exclusive,
      notes: bonus.notes,
      geoMode: bonus.geoMode,
      allowedCountries: bonus.allowedCountries,
      blockedCountries: bonus.blockedCountries,
      status: bonus.status,
