...
import { bonusGuideReadNextSelection } from "@/lib/articles/learn-selection";
...
export default async function BonusGuidePage() {
  ...
  // "Read next" lists real published English guides only; with none, the row is not rendered.
