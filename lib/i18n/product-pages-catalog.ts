...
export type ProductPageMessages = Readonly<{
  ...
  bestOffers: Readonly<{
    ...
    /** Hero copy when no country is known (the global list), instead of naming "the global catalog". */
    heroCopyWorldwide: string;
    ...
    /** Heading of the method section under the shortlist. */
    methodTitle: string;
...
const en: ProductPageMessages = {
  common: {
    ...
    marketPresentationNotice: "Presentation reflects the detected region. It does not prove location, eligibility or commercial availability.",
  ...
  bestOffers: {
    ...
    heroLead: "Three picks.", heroEmphasis: "Not thirty.", heroKicker: "Current editorial shortlist for {market}", heroCopy: "Offers for {market}. Partner links appear only when they are available for this visit.",
    heroCopyWorldwide: "Offers from around the world. Partner links appear only when they are available for this visit.",
    ...
    worthALookTitle: "Worth a look — just outside the top three", whyTitle: "Why these records are shown", whyCopy: "Market availability, complete material terms and source status are checked before ranking. Commercial availability is checked separately.", methodTitle: "How we pick", finalKicker: "Still here? The answer hasn't changed.",
    ...
    faqCommissionQuestion: "Do you earn money if I sign up?", faqCommissionAnswer: "B4GAMBLE may earn commission when a clearly labelled affiliate link is available and used. Offers we can link to are listed first; within each group, the editorial score sets the order. Commission never changes the editorial score.",
  ...
  profile: {
    ...
    marketUnavailable: "{market}: exact local profile not separately verified", marketUnavailableCopy: "Global editorial evidence is shown below; partner-link availability is governed independently.",
...
const compactTranslations = {
  ...
  "es-ES": ["Reseñas y comparaciones transparentes para {market}.","La presentación refleja la región detectada; no demuestra elegibilidad ni disponibilidad comercial.","No hay registros aptos para {market}.","Aún no hay reseñas publicadas para {market}.","No hay bonos aptos para {market}.","Solo reseña para {market}"],
  ...
  "sv-SE": ["Tydliga recensioner och jämförelser för {market}.","Presentationen följer den upptäckta regionen; den bevisar inte behörighet eller kommersiell tillgänglighet.","Inga kvalificerade poster för {market}.","Inga publicerade recensioner för {market} ännu.","Inga kvalificerade bonusar för {market}.","Endast recension för {market}"],
  "da-DK": ["Gennemsigtige anmeldelser og sammenligninger for {market}.","Præsentationen følger den registrerede region; den beviser ikke berettigelse eller kommerciel tilgængelighed.","Ingen kvalificerede poster for {market}.","Ingen offentliggjorte anmeldelser for {market} endnu.","Ingen kvalificerede bonusser for {market}.","Kun anmeldelse for {market}"],
  ...
  "nb-NO": ["Åpne anmeldelser og sammenligninger for {market}.","Presentasjonen følger den registrerte regionen; den beviser ikke kvalifisering eller kommersiell tilgjengelighet.","Ingen kvalifiserte oppføringer for {market}.","Ingen publiserte anmeldelser for {market} ennå.","Ingen kvalifiserte bonuser for {market}.","Kun anmeldelse for {market}"],
} as const;
...
function localeVariant(locale: keyof typeof compactTranslations): ProductPageMessages {
  ...
  return {
    ...
    bestOffers: {
      ...
      heroLead:n.best,heroEmphasis:n.terms,heroKicker:`${n.best} · {market}`,heroCopy:copy[0],heroCopyWorldwide:copy[0],eligibleRecords:n.records,currentMarket:n.current,inferredActions:n.action,rankingLink:`${n.methodology} →`,
      ...
      worthALookTitle:`${n.browse} · ${n.records}`,whyTitle:n.methodology,whyCopy:method,methodTitle:n.methodology,finalKicker:n.current,beforeClick:n.terms,
...
const languageQualityOverrides = {
  "en-GB": {
    common: {
      ...
      marketPresentationNotice: "Presentation reflects the detected region. It does not confirm your location, eligibility or whether an offer is available.",
    ...
    bestOffers: {
      heroCopy: "Offers for {market}. Partner links appear only when they are available for this visit.",
      heroCopyWorldwide: "Offers from around the world. Partner links appear only when they are available for this visit.",
      methodTitle: "How we pick",
      ...
      faqCommissionAnswer: "B4GAMBLE may earn commission when a clearly labelled affiliate link is available and used. Offers we can link to are listed first; within each group, the editorial score sets the order. Commission never changes the editorial score.",
    },
    casinos: {
    ...
    profile: {
      ...
      marketUnavailable: "{market}: exact local profile not separately verified",
      marketUnavailableCopy: "Global editorial evidence is shown below; partner-link availability is governed independently.",
  ...
  "de-DE": {
    common: {
      ...
      marketPresentationNotice: "Die Darstellung berücksichtigt die erkannte Region. Sie bestätigt weder deinen Standort noch deine Berechtigung oder die Verfügbarkeit eines Angebots.",
    ...
    bestOffers: {
      ...
      heroCopy: "Angebote für {market}. Partnerlinks erscheinen nur, wenn sie für diesen Besuch verfügbar sind.",
      ...
      faqCommissionAnswer: "B4GAMBLE kann Provision erhalten, wenn du einen verfügbaren und klar gekennzeichneten Affiliate-Link nutzt. Angebote, auf die wir verlinken können, stehen zuerst; innerhalb jeder Gruppe bestimmt die redaktionelle Bewertung die Reihenfolge. Provision verändert die redaktionelle Bewertung nie.",
    },
    casinos: {
    ...
    profile: {
      ...
      marketUnavailable: "{market}: Exaktes lokales Profil nicht separat verifiziert",
      marketUnavailableCopy: "Globale redaktionelle Nachweise werden unten angezeigt; die Verfügbarkeit des Partnerlinks wird unabhängig gesteuert.",
  ...
  "es-ES": {
    common: {
      ...
      marketPresentationNotice: "La presentación refleja la región detectada. No confirma tu ubicación, si cumples los requisitos ni si hay una oferta disponible.",
    ...
    bestOffers: {
      heroCopy: "Ofertas para {market}. Los enlaces a ofertas solo aparecen cuando están disponibles para esa visita.",
      heroCopyWorldwide: "Ofertas de todo el mundo. Los enlaces a ofertas solo aparecen cuando están disponibles para esa visita.",
      methodTitle: "Cómo elegimos",
      ...
      faqCommissionAnswer: "B4GAMBLE puede recibir una comisión si utilizas un enlace de afiliación disponible y claramente identificado. Las ofertas a las que podemos enlazar aparecen primero; dentro de cada grupo, la puntuación editorial decide el orden. La comisión nunca cambia la puntuación editorial.",
    ...
    profile: {
      ...
      marketUnavailable: "{market}: el perfil local exacto no se ha verificado por separado",
      marketUnavailableCopy: "Las evidencias editoriales globales se muestran a continuación; la disponibilidad del enlace de socio se controla por separado.",
  ...
  "sv-SE": {
    common: {
      ...
      marketPresentationNotice: "Presentationen följer den upptäckta regionen. Den bekräftar inte var du befinner dig, om du uppfyller villkoren eller om ett erbjudande är tillgängligt.",
    ...
    bestOffers: {
      ...
      heroCopy: "Erbjudanden för {market}. Partnerlänkar visas bara när de är tillgängliga för det aktuella besöket.",
      heroCopyWorldwide: "Erbjudanden från hela världen. Partnerlänkar visas bara när de är tillgängliga för det aktuella besöket.",
      methodTitle: "Hur vi väljer",
      ...
      faqCommissionAnswer: "B4GAMBLE kan få provision om du använder en tillgänglig och tydligt märkt affiliatelänk. Erbjudanden som vi kan länka till visas först; inom varje grupp avgör det redaktionella betyget ordningen. Provision ändrar aldrig det redaktionella betyget.",
    ...
    profile: {
      ...
      marketUnavailable: "{market}: exakt lokal profil har inte verifierats separat",
      marketUnavailableCopy: "Globala redaktionella belägg visas nedan; partnerlänkens tillgänglighet styrs separat.",
  ...
  "da-DK": {
    common: {
      ...
      marketPresentationNotice: "Præsentationen følger den registrerede region. Den bekræfter ikke din placering, om du opfylder kravene, eller om et tilbud er tilgængeligt.",
    ...
    bestOffers: {
      ...
      heroCopy: "Tilbud for {market}. Partnerlinks vises kun, når de er tilgængelige for det aktuelle besøg.",
      heroCopyWorldwide: "Tilbud fra hele verden. Partnerlinks vises kun, når de er tilgængelige for det aktuelle besøg.",
      methodTitle: "Hvordan vi vælger",
      ...
      faqCommissionAnswer: "B4GAMBLE kan modtage provision, hvis du bruger et tilgængeligt og tydeligt markeret affiliatelink. Tilbud, som vi kan linke til, vises først; inden for hver gruppe afgør den redaktionelle vurdering rækkefølgen. Provision ændrer aldrig den redaktionelle vurdering.",
    ...
    profile: {
      ...
      marketUnavailable: "{market}: den præcise lokale profil er ikke verificeret separat",
      marketUnavailableCopy: "Global redaktionel dokumentation vises nedenfor; partnerlinkets tilgængelighed styres separat.",
  ...
  "el-GR": {
    common: {
      ...
      marketPresentationNotice: "Η παρουσίαση ακολουθεί την περιοχή που εντοπίστηκε. Δεν επιβεβαιώνει την τοποθεσία σου, αν πληροίς τις προϋποθέσεις ή αν υπάρχει διαθέσιμη προσφορά.",
    ...
    bestOffers: {
      ...
      heroCopy: "Προσφορές για την αγορά {market}. Οι σύνδεσμοι προσφορών εμφανίζονται μόνο όταν είναι διαθέσιμοι για τη συγκεκριμένη επίσκεψη.",
      heroCopyWorldwide: "Προσφορές από όλο τον κόσμο. Οι σύνδεσμοι προσφορών εμφανίζονται μόνο όταν είναι διαθέσιμοι για τη συγκεκριμένη επίσκεψη.",
      methodTitle: "Πώς επιλέγουμε",
      ...
      faqCommissionAnswer: "Η B4GAMBLE μπορεί να λάβει προμήθεια αν χρησιμοποιήσεις έναν διαθέσιμο σύνδεσμο συνεργάτη με σαφή επισήμανση. Οι προσφορές στις οποίες μπορούμε να σε παραπέμψουμε εμφανίζονται πρώτες· μέσα σε κάθε ομάδα, τη σειρά την ορίζει η συντακτική βαθμολογία. Η προμήθεια δεν αλλάζει ποτέ τη συντακτική βαθμολογία.",
    ...
    profile: {
      ...
      marketUnavailable: "{market}: το ακριβές τοπικό προφίλ δεν έχει επαληθευτεί ξεχωριστά",
      marketUnavailableCopy: "Τα καθολικά συντακτικά τεκμήρια εμφανίζονται παρακάτω· η διαθεσιμότητα του συνδέσμου συνεργάτη ελέγχεται ξεχωριστά.",
