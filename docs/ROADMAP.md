...
| Supporting track | Frontend Migration Audit and P0 Plan | Audit complete; FE-MIG-01 Public Shell is merged in `ceee4e7`, FE-MIG-02 Home parity in `bef86bd`, FE-MIG-03 10 Steps in `d85146e`, FE-MIG-04 Casinos baseline in `5090cec`, and FE-MIG-05 Casino Profile in `2b35822`. FE-MIG-06 Casino Directory is implemented in [PR #23](https://github.com/AlexG-7BE/sevenbet-next/pull/23) from `2b35822`, preserving dynamic SSR, published snapshots, URL-authoritative controls, ItemList/canonical/noindex rules and governed actions while mapping the approved `520:2496` / `521:312` family; protected Preview smoke passes and Founder Office review remains pending. `/self-check` and `/tools/budget-calculator` remain launch-blocked as `P0_REDESIGN_REQUIRED` under FE-SAFETY-01. | 2026-08-06 |
