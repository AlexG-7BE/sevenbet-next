...
export const PUBLIC_LOCALIZATION_ROUTE_MANIFEST = [
  ...
  { root: "10-steps", match: "EXACT", policy: "UNPREFIXED_ONLY" },
  { root: "about", match: "EXACT", policy: "UNPREFIXED_ONLY" },
  { root: "bonus-guide", match: "EXACT", policy: "UNPREFIXED_ONLY" },
  { root: "catalog", match: "EXACT", policy: "UNPREFIXED_ONLY" },
  { root: "contact", match: "EXACT", policy: "UNPREFIXED_ONLY" },
  { root: "faq", match: "EXACT", policy: "UNPREFIXED_ONLY" },
  { root: "launch-polish-error-harness", match: "EXACT", policy: "UNPREFIXED_ONLY" },
  { root: "learn", match: "SUBTREE", policy: "UNPREFIXED_ONLY" },
  { root: "login", match: "EXACT", policy: "UNPREFIXED_ONLY" },
  { root: "methodology", match: "EXACT", policy: "UNPREFIXED_ONLY" },
