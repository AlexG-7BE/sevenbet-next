...
export async function GET() {
  ...
  const paymentMethods = [
    ...
    payment({ key: "apple-pay", name: "Apple Pay", deposits: true, withdrawals: false, minDeposit: "10", maxDeposit: "5000", type: "EWALLET", sortOrder: 2, notes: "Listed as a current GoldenPlay deposit method. Withdrawal support was not established in the current cashier evidence." }),
    payment({ key: "google-pay", name: "Google Pay", deposits: true, withdrawals: false, minDeposit: "10", maxDeposit: "5000", type: "EWALLET", sortOrder: 3, notes: "Listed as a current GoldenPlay deposit method. Withdrawal support was not established in the current cashier evidence." }),
    payment({ key: "skrill", name: "Skrill", deposits: true, withdrawals: true, minDeposit: "20", maxDeposit: "5000", minWithdrawal: "10", withdrawalTime: "Up to 4 business days in current cash-out guidance", type: "EWALLET", sortOrder: 4, notes: "Current cashier evidence shows multiple Skrill routes with different deposit bands; exact route/limit is account-dependent." }),
    payment({ key: "neteller", name: "Neteller", deposits: true, withdrawals: true, minDeposit: "20", maxDeposit: "5000", minWithdrawal: "10", withdrawalTime: "Up to 4 business days in current cash-out guidance", type: "EWALLET", sortOrder: 5, notes: "Current cashier evidence shows multiple Neteller routes with different deposit bands; exact route/limit is account-dependent." }),
    payment({ key: "cashlib", name: "Cashlib", deposits: true, withdrawals: false, minDeposit: "10", maxDeposit: "5000", type: "VOUCHER", sortOrder: 6, notes: "Current EUR cashier evidence lists Cashlib as a deposit method." }),
    payment({ key: "mifinity", name: "MiFinity", deposits: true, withdrawals: false, minDeposit: "10", maxDeposit: "5000", type: "EWALLET", sortOrder: 7, notes: "Current EUR cashier evidence lists MiFinity as a deposit method." }),
    payment({ key: "revolut", name: "Revolut", deposits: true, withdrawals: false, minDeposit: "10", maxDeposit: "5000", type: "EWALLET", sortOrder: 8, notes: "Current GoldenPlay Ireland/EUR research lists Revolut as a deposit method." }),
    ...
    payment({ key: "flexepin", name: "Flexepin", deposits: true, withdrawals: false, minDeposit: "10", maxDeposit: "250", type: "VOUCHER", sortOrder: 10, notes: "Current EUR cashier evidence lists Flexepin as a deposit method." }),
