...
| Product decision | RFC-012 — Temporary Production Synthetic Casino Dataset | Approved as a bounded production-data exception; five clearly fictional `demo-*` casino records use the current schema and publication flow, with exact-ID cleanup and no separate Demo infrastructure or external gambling destination | 2026-08-06 |
