...
const de: DemoProfileCopy = {
  ...
  pros: ["Personen, die häufig Auszahlungen vornehmen", "Fans virtueller Automatenspiele", "Alle, die genug von Auszahlungsverzögerungen haben"],
  cons: ["Einige Spiele zählen nicht für die Umsatzbedingung", "Nicht in allen Ländern verfügbar", "VIP-Vorteile beginnen erst nach Echtgeldspiel"],
  responsibleGamblingTools: ["Einzahlungslimits", "Auszeiten", "Selbstausschluss"],
  bankTransfer: "Banküberweisung",
  instant: "Sofort",
  liveDealer: "Video-Slots",
  bonus: {
  ...
  editorial: {
    ...
    categories: ["Auszahlungen", "Bonusbedingungen", "Spielauswahl und RTP", "Kundendienst"],
    sections: [
      ...
      ["games", "Spiele", "Beispielhafte Felder zu Spieleanzahl, Spielkategorien und RTP eines fiktiven Anbieters. Es wurde kein Anbieterkatalog geprüft."],
