...
- **LAUNCH-POLISH-01:** **CURRENT MAIN INTEGRATED / LOCAL GATES PASS / EXTERNAL MAIL ACTIVATION DEFERRED.** Normal merge commit `0d2e67e6415566459c8c79bd2d6e6f6c2a59e67d` integrates current main and preserves PR #69 and PR #70. RFC-028 governs the resilient public 404/error hierarchy, `/contact`, `POST /api/contact`, isolated direct-HTTPS Resend adapter, privacy/retention delta, bounded link audit and WAF activation contract. Root quality, legal, Agent Core, build, 742-file secret scan, 71-route link audit, non-database browser, 19-migration fresh-database, PostgreSQL runtime and 9/9 database-backed browser gates pass. Existing Vercel Pro supports the exact fixed-window/IP/429 rule at `$0.50` per 1,000,000 allowed requests after its included allowance, but the rule remains unapplied. Resend account/plan inspection is waiting at a GitHub OAuth permission screen. No mail DNS, Contact environment variable, Preview/Production send, WAF rule, Production data or runtime flag has been changed; the 2026-08-14 09:00 Asia/Almaty mail-DNS boundary has not passed.
