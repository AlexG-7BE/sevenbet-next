...
|---|---:|---|
| `APPROVED` | 12 | Public Header, revised Public Footer, `/10-steps`, Casinos catalogue/empty state, Casino Profile available/unavailable, Bonuses catalogue/lifecycle, Best Offers shortlist and Comparison selection/result/no-comparable families are visually approved across their completed responsive states. |
| `DESIGNED_NEEDS_QA` | 17 | Current Tilt-Locked design exists but user approval, responsive QA or wider journey handoff remains outstanding. Programme now includes the complete mobile review family through Mission 04. |
...
| `MISSING` | 23 | No adequate active Figma family was detected. |
...
| Desktop screens | Page `6:6`; Home, original Bonuses anchor `299:786`, approved Bonuses family `541:3002`, original Best Offers anchor `310:224`, approved Best Offers family `556:3336`, approved Casinos family `520:2496`, original Casino Profile anchor `343:601`, approved Casino Profile family `529:2850`, approved Comparison family `567:3592`, Protected article, Programme M01–M04 and `/10-steps` family `502:2238` | `/10-steps`, Casinos, Casino Profile, Bonuses, Best Offers and Comparison are approved. Comparison covers 1,440, 1,280 and ten explicit desktop states. |
| Mobile | Page `6:7`; Public Shell family `492:2268`, revised `/10-steps` family `502:2412`, Casinos family `521:312`, Casino Profile family `530:809`, Bonuses family `541:3950`, approved Best Offers family `557:1470`, approved Comparison family `569:1589` and Programme review family `580:1713` | Public Shell, `/10-steps`, Casinos, Casino Profile, Bonuses, Best Offers and Comparison are approved. Programme through Mission 04 is `DESIGNED_NEEDS_QA` across 17 journey representatives, 13 recovery/control states and four 375 first folds. |
...
| C01 | Programme | Mission 01 | `/program` | Build the Moment Map before registration | `DESIGNED_NEEDS_QA` | Desktop `409:699`–`412:1004` (board `407:699`); mobile `580:1721`, `580:1758`, `580:1794` | 8 desktop screens preserved | 3 representative 390 screens; 375 first fold `583:2034` | **Detected — active** | Mission 01 APIs/session | +60 XP; no commercial targeting/linkage | P0 | Await visual approval of the responsive review family; preserve the desktop flow. |
| C02 | Programme / Identity | Registration after earned result | `/program` state | Persist earned result and claim reward | `DESIGNED_NEEDS_QA` | Desktop `413:963`, `413:1002`; mobile `580:1826`, `580:1852`, `583:1738`, `583:1763`, `583:1788` | Designed | Earned-result gate, form, validation and recovery; 375 first fold `583:2071` | **Detected — active** | Better Auth sign-up and claim redemption | Separate required terms from optional marketing; privacy notice | P0 | Await visual approval; unsupported auth methods remain excluded. |
| C03 | Programme / Identity | Returning-user sign-in | `/program?auth=sign-in` | Resume private Programme | `DESIGNED_NEEDS_QA` | Desktop `413:1002`, fields `404:38`–`404:73`; mobile `583:1715` | Shared desktop form | Explicit returning 390 state | **Detected — active** | Better Auth email/password | Avoid implying unsupported recovery | P0 | Await visual approval; email/password only. |
| C04 | Programme / Identity | Account claim error / recovery | `/program` state | Recover without losing earned Mission 01 work | `DESIGNED_NEEDS_QA` | Fields `404:53`, `404:73`; mobile `583:1738`, `583:1763`, `583:1788`, `583:1813` | Component errors preserved | Full validation, duplicate-account, claim-expiry and anonymous-session-expiry states | **Detected — active/partial** | Session and claim error codes | Preserve private artefact; no reward duplication | P0 | Await visual approval; production reason mapping remains an engineering dependency. |
| C05 | Programme | Personal Control Dashboard after M01 | `/program` state | Show saved artefact, progress and next mission | `DESIGNED_NEEDS_QA` | Desktop `413:1044`; mobile `580:1879` | Designed | 390 representative | **Detected — active** | Dashboard service | Private/commercial data separation | P0 | Await visual approval and later frontend parity. |
...
| C07 | Programme | Mission 02 | `/program` state | Build the 7-day goal | `DESIGNED_NEEDS_QA` | Desktop `419:1058`–`422:1439`; mobile `580:1914`, `580:1947` | 8 screens preserved | 2 representative 390 screens | **Detected — active** | Mission 02 service and artefact | +80 XP and First Plan achievement | P0 | Await visual approval and later frontend parity. |
| C08 | Programme | Dashboard after M02 | `/program` state | Reflect 140 XP, artefacts and Mission 03 | `DESIGNED_NEEDS_QA` | Desktop `428:1532`; mobile `580:1983` | Designed | 390 representative | **Detected — active** | Dashboard/rewards | Truthful progress and reward totals | P0 | Await visual approval. |
| C09 | Programme | Mission 03 | `/program` state | Urge literacy and early signal | `DESIGNED_NEEDS_QA` | Desktop family `449:1413`; mobile `581:1713`, `581:1747`, `581:1785`; states `583:1886`, `583:1911`, `583:1934` | 8 screens preserved | 3 journey and 3 explicit 390 states | **Detected — active** | Mission 03 service/artefact | +90 XP; “Not now” remains valid | P0 | Await visual approval; personal signal remains optional. |
| C10 | Programme | Dashboard after M03 | `/program` state | Reflect 230 XP and Mission 04 | `DESIGNED_NEEDS_QA` | Desktop `456:1699`; mobile `581:1817` | Designed | 390 representative | **Detected — active** | Dashboard/rewards | Private artefact handling | P0 | Await visual approval. |
| C11 | Programme | Mission 04 — Build one boundary | `/program` state | Create one executable boundary | `DESIGNED_NEEDS_QA` | Desktop family `468:1753`; mobile `581:1852`, `581:1888`, `581:1926`; paused `583:1957`; edit `583:1982`; delete `583:2007` | 9 screens preserved | 3 journey and 3 control-state representatives; 375 first fold `583:2098` | **Detected — active** | Mission 04 service/boundary artefact | +100 XP, Boundary Built; Help path protected | P0 | Await visual approval and explicit release-gate review. |
| C12 | Programme | Dashboard after M04 / M05 placeholder | `/program` state | Reflect 330 XP, 4/10 and next placeholder | `DESIGNED_NEEDS_QA` | Desktop `470:358`; mobile `581:1962`; 375 first fold `583:2134` | Designed; factual placeholder copy corrected | 390 and 375 representative; disabled Mission 05 placeholder | **Detected — active** | Dashboard registry | Do not design Mission 05 itself | P0 | Await visual approval; Mission 05 remains placeholder only. |
| C13 | Programme | Paused Programme state | `/program` state | Respect a user pause without pressure | `DESIGNED_NEEDS_QA` | Mobile `583:1957` | Existing desktop journey preserved | 390 paused/re-entry representative | **Not detected as a dedicated frontend state** | Pause state contract | No commercial targeting from pause; protected Help available | P1 | Visual state awaits approval; implementation remains blocked on an explicit capability contract. |
...
| C15 | Programme | Reward / achievement feedback | `/program` state | Recognise educational/control progress | `DESIGNED_NEEDS_QA` | `402:63`, `411:38`, `417:51`, `465:10`, `465:15`; mobile results `580:1794`, `580:1947`, `581:1785`, `581:1926` | Designed | Four representative result/reward screens | **Detected — active** | Reward ledger and idempotency | Never reward gambling/commercial action | P0 | Await visual approval; announcement/accessibility and failure mapping remain handoff gates. |
| C16 | Programme | Artefact edit / delete states | `/program` overlay/state | User control over private work | `DESIGNED_NEEDS_QA` | Desktop fragments `469:223`, `470:237`; mobile edit `583:1982`, delete confirmation `583:2007` | Flow fragment preserved | Explicit 390 edit and destructive-confirmation representatives | **Detected — edit only** | Artefact update/delete contract | Confirmation, privacy and audit behaviour | P0 | Await visual approval; success/failure reason mapping remains implementation work. |
| C17 | Programme | Session expired / error / recovery | `/program` state | Continue safely after auth/network/session failure | `DESIGNED_NEEDS_QA` | Mobile claim expiry `583:1788`, anonymous expiry `583:1813`, saving `583:1838`, network retry `583:1861` | Existing generic treatment preserved | Four explicit 390 recovery representatives | **Detected — generic errors only** | Session/claim/mission error codes | No data loss or duplicate reward promise | P0 | Await visual approval; production error-code mapping remains an engineering dependency. |
...
- The launch journey has an approved responsive Public Shell and approved revised `/10-steps`, Casinos, Casino Profile, Bonuses, Best Offers and Comparison families, but no dedicated Protected Help shell or legal-system template set.
...
- Full 390×844 mobile frames are still required for Home and Protected Help. Programme Dashboard, registration and sign-in now have review-ready 390 representatives; public discovery families are approved.
...
8. **Programme QA through Mission 04 — DESIGNED_NEEDS_QA** — mobile representatives and recovery/control states are review ready; desktop work remains preserved and user visual approval is pending.
...
## Eighth design action — PROGRAMME THROUGH MISSION 04 AWAITING VISUAL APPROVAL

The **Programme through Mission 04 review family** is designed in Figma as mobile family `580:1713` with status label `580:1714`, responsive contract `580:1715`, journey section `580:1719`, state section `583:1713` and small-mobile section `583:2032`. Status remains `DESIGNED_NEEDS_QA`; this document does not infer user approval. Existing desktop families and component sources remain the governing desktop direction and were not redesigned.
...
After Programme visual approval, the next P0 candidate is **Protected Help**: dedicated protected shell, landing and representative article/support states without commercial prompts.
