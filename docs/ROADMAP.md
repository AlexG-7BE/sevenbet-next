...
| 13 | COMM-01 — GB Commercial Partner Authority | **Implementation complete — PR #55 open for Founder review** | RFC-015 adds typed agreement/domain authority, programme/offer/link/bonus gates, provider-import safety, a five-candidate shortlist and onboarding pack. No real partner or destination was added; policy/referral remain off. |
