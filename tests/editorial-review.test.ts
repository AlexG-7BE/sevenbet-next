...
function document(): CasinoEditorialDocument {
  return { version: 1, title: "Example Casino Review", summary: "A factual editorial summary.", author: "Editorial Team", sections: [{ id: "overview", kind: "overview", title: "Overview", order: 0, blocks: [{ id: "intro", type: "paragraph", text: "Structured review content." }, { id: "safer-play", type: "responsible-gambling", title: "Pause first", text: "Set limits before registering." }] }], relatedCasinoIds: [], seo: { title: "Example Casino Review | B4GAMBLE", description: "A factual editorial summary." } };
}
