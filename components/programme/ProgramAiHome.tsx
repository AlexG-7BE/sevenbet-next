      ...
      <main className={styles.dashboard}>
        ...
        <div className={styles.dashboardGrid}>
          ...
          <div className={styles.dashboardRight}>
            <section className={styles.compactStats} aria-label="Programme progress"><div><span className="srOnly">{home.totalXp} XP</span><strong aria-hidden="true">{home.totalXp}</strong><span aria-hidden="true">XP</span></div><div><strong>{home.currentStreak}</strong><span>day streak</span></div><div><strong>{home.activeDays}</strong><span>active days</span></div></section>
