    ...
    <AdminPageShell area="analytics" title="Analytics" intro="Fixed Product Core dashboards. Production human traffic only; Preview, test, internal, and obvious bot traffic is excluded.">
      ...
      {view === "commercial" && "outboundAttempts" in data ? <>
        <div className="adminStatsGrid">
          <AdminStatCard label="Casino views" value={data.casinoViews} note="Canonical events" />
          <AdminStatCard label="Offer views" value={data.offerViews} note="CTR denominator" />
          <AdminStatCard label="Commercial card views" value={data.cardViews} note="Consented visible cards" />
          <AdminStatCard label="View selections" value={data.viewSelections} note="Consented presentation changes" />
          <AdminStatCard label="Casino review clicks" value={data.reviewClicks} note="Consented internal navigation" />
          <AdminStatCard label="CTA clicks" value={data.ctaClicks} note="Consented commercial clicks" />
