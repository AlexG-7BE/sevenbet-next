...
| Outbound confirmation | Leaving B4GAMBLE, commission, no score/ranking influence, 18+/eligibility/operator terms/financial risk; continue or stay | Detected / unreachable for real GB traffic while gates deny | `components/casino-profile/CasinoOutboundAction.tsx`; `components/commercial-handoff/CommercialHandoffPage.tsx` |
