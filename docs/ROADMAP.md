...
| 29 | LAUNCH-POLISH-01 | **IMPLEMENTED ON DRAFT REVIEW BRANCH; EXTERNAL ACTIVATION DEFERRED** | RFC-027 governs root 404/error resilience, public Contact, Contact-only direct-HTTPS Resend transport, privacy/retention delta, link audit and the prepared Vercel WAF rule. Code/local/browser/build/link gates pass. No mail DNS, provider account, real delivery, WAF, Production env/data or merge action has occurred. |
| 30 | Regulated GB commercial release | **Blocked** | External legal/regulatory, partner/data, privacy/processor and separate activation gates remain. |
...
4. Keep Contact delivery, mail DNS and WAF external activation behind RFC-027's remaining Founder/date/provider/privacy/Preview gates. If account or Programme reminder delivery is desired, approve its separate sending domain, mailboxes and transport before COMMS-REMINDER-01.
