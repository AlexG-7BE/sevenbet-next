...
export const FIRST_WAVE_MARKET_EVIDENCE = {
  ...
  SE: {
    ...
    copy: {
      eyebrow: "Kontroll och stöd", helpTitle: "Hjälp som hålls skild från det kommersiella.", helpLead: "Verifierade svenska vägar till självavstängning och oberoende stöd.", responsibleTitle: "Ansvarsfullt spelande", responsibleLead: "Saklig information om kontroll och stöd — utan diagnos eller erbjudanden.", resourcesTitle: "Verifierade externa resurser", selfExclusionTitle: "Självavstängning", supportTitle: "Stöd", informationTitle: "Information", reviewedLabel: "Evidens granskad", sourceLabel: "Källa", externalLabel: "Öppna extern webbplats", unavailable: "Ingen verifierad lokal resurs är tillgänglig.", nonCommercial: "Inga spelbolag, bonusar eller affiliateåtgärder visas på den här sidan.", disclaimer: "B4GAMBLE är varken tillsynsmyndighet eller vård- eller stödleverantör. Kontrollera tjänst och integritet hos respektive aktör.", urgent: "Vid omedelbar fara, kontakta lokala akuttjänster. B4GAMBLE är inte en akut- eller klinisk tjänst.",
    },
  },
  DK: {
    ...
    copy: {
      eyebrow: "Kontrol og støtte", helpTitle: "Hjælp, der holdes adskilt fra det kommercielle.", helpLead: "Verificerede danske veje til udelukkelse, fortrolig rådgivning og behandlingstilbud.", responsibleTitle: "Ansvarligt spil", responsibleLead: "Nøgtern information om kontrol og støtte — uden diagnose eller tilbud.", resourcesTitle: "Verificerede eksterne ressourcer", selfExclusionTitle: "Udelukkelse", supportTitle: "Rådgivning og behandling", informationTitle: "Information", reviewedLabel: "Evidens gennemgået", sourceLabel: "Kilde", externalLabel: "Åbn ekstern side", unavailable: "Ingen verificeret lokal ressource er tilgængelig.", nonCommercial: "Denne side viser ingen spiludbydere, bonusser eller affiliatehandlinger.", disclaimer: "B4GAMBLE er hverken myndighed eller behandlingsudbyder. Kontrollér tjeneste og privatliv hos den enkelte aktør.", urgent: "Ved akut fare skal du kontakte de lokale alarmtjenester. B4GAMBLE er ikke en akut eller klinisk tjeneste.",
    },
  },
  GR: {
