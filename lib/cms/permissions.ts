...
export const permissionsByRole: Record<AdminRole, CmsPermission[]> = {
  ...
  EDITOR: ["article.create", "article.edit", "article.review", "program.edit", "casino.edit", "bonus.edit"],
  AUTHOR: ["article.create", "article.edit"],
  REVIEWER: ["article.review", "casino.edit", "bonus.edit"],
  AFFILIATE_MANAGER: ["affiliate.manage", "casino.edit", "bonus.edit"],
