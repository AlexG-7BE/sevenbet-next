...
| Supporting track | Frontend Migration Audit and P0 Plan | Audit complete; FE-MIG-01 through FE-MIG-07 are merged, including FE-MIG-07 Bonus Directory in [PR #25](https://github.com/AlexG-7BE/sevenbet-next/pull/25) at `8f79478`. FE-MIG-08 Best Offers is implemented on `codex/fe-mig-08-best-offers` from that merged base and maps approved Figma families `556:3336` / `557:1470` to a canonical server-rendered database shortlist, generic overall/lower-wagering/faster-payout selectors, complete material terms, `ItemList`, fail-closed actions and no-JavaScript states. Separate PR, protected Preview and Founder review remain gates. The bounded RFC-012 production demo tuning changed only four intended published snapshots and converges unchanged on repeat seed. `/self-check` and `/tools/budget-calculator` remain launch-blocked as `P0_REDESIGN_REQUIRED` under FE-SAFETY-01. | 2026-08-06 |
